...
export default function SuporteModal() {
  ...
  useEffect(() => {
    if (!suporteModalOpen) {
      setForm({ solicitacaoId: undefined, direcao: 'enviada', assunto: '', conteudo: '', remetente: 'Você' })
      setErrors({})
  ...
  const mensagensRecebidas = mensagens.filter((m) => m.direcao === 'recebida')
      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col">
        ...
        <div className="flex border-b border-gray-200 overflow-x-auto">
          {TABS.map((tab) => (
            ...
            >
              {tab.label}
              {tab.id === 'inbox' && mensagensNaoLidas.length > 0 && (
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {suporteModalTab === 'enviar' && (
            <div className="max-w-2xl space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Solicitação (opcional)</label>
                <select
              ...
              <div>
                ...
                <input
                  ...
                  className={cn(inputBase, errors.assunto && inputError)}
              ...
              <div>
                ...
                <textarea
                  ...
                  className={cn(inputBase, 'min-h-[120px]', errors.conteudo && inputError)}
              ...
              <div className="flex gap-3">
                <button type="button" onClick={handleEnviar} className={btnPrimary}>
                  Enviar mensagem
                </button>
              </div>
            </div>
          ...
          {suporteModalTab === 'inbox' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-semibold text-gray-800">Mensagens recebidas</h3>
              ...
              {mensagensRecebidas.length === 0 ? (
                <p className="text-sm text-gray-500 py-8 text-center">Nenhuma mensagem recebida.</p>
              ) : (
