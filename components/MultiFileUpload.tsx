      ...
      >
        ...
        >
          ...
          <span className="text-sm text-gray-500 font-medium">
            Toque para anexar ou arraste aqui — boleto e nota fiscal (mín. {minFiles} arquivos)
          </span>
        </label>
            ...
            {files.map((file, index) => (
              <div key={index} className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[11px] text-gray-500">{(file.size / 1024).toFixed(1)} KB {index === 0 && '— Boleto'} {index === 1 && '— Nota fiscal'}</p>
                </div>
                <button
                  type="button"
